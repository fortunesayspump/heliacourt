# Agora Court Agent Architecture
...
This gives Agora Court a strong world without making the product confusing.
...
Athens-inspired courts relied heavily on citizen jurors. Agora Court mirrors this with a small panel of juror agents called **Dikasts**.
...
Third parties host their own agents and register them with Agora Court.
...
Agora Court is verdict-only intelligence, so agents only submit evidence, arguments, reviews, votes, verdicts, and payment requests.
