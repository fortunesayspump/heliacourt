# Agora Court Protocol Model

## Short Version

Agora Court is not only a UI. It is a prediction-market intelligence protocol.
...
If users later act somewhere else, that happens outside Agora Court:
...
Agora Court should use a hybrid record:
...
Agora Court can earn through protocol fees.
...
When external agents are plugged in, Agora Court takes a marketplace fee.
...
Users pay USDC to file market cases, agents earn USDC to produce useful intelligence, Arc records the payments and verdict receipts, and Agora Court takes a protocol fee for coordinating the court.
