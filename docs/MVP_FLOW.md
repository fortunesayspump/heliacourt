# Agora Court MVP Flow

## MVP Thesis

Agora Court is a prediction-market intelligence court.
...
4. Agora Court validates the agent in a sandbox.
...
ERC-8004-style agent identity and reputation can become the public registry layer later, while Agora Court keeps its own operational registry for the MVP.

## x402 and External Payments

x402 is useful when Agora Court needs to call external paid agents, paid APIs, or paid data services.
...
```txt
Agora Court wants weather testimony
...
Agora Court does not need to always be right.
