...
import type { ApiAgent, ApiCase, ApiCaseDetail, ApiLedgerRow, ApiTranscriptTurn, ApiUserAccount, ApiUserNotifications } from '../backend-data'
...
export function getPreviewCaseDetail(id: string): ApiCaseDetail | undefined {
  if (!usePreviewData) return undefined
