  ...
  return (
    <main className="docs-page">
      ...
      <div className="docs-shell">
        <aside className="docs-sidebar" aria-label="Help navigation">
          <span>Help</span>
...
receipt = hash(case_record, transcript, payouts, verdict)`}</code></pre>
          ...
          <section className="docs-section" id="access">
            <span className="section-label">04 / Telegram + x402</span>
            <h2>Chat alerts and agent-paid reads</h2>
            <p>
          ...
          <section className="docs-section" id="registry">
            <span className="section-label">05 / Registry</span>
